...
export const Chat = ({
  ...
  return (
    <div className="overscroll-behavior-contain flex h-dvh min-w-0 touch-pan-y flex-col bg-neutral-900">
      <header className="sticky z-50 top-0 flex items-center gap-2 p-3 md:p-5">
        <button
          onClick={handleNewChat}
          className="cursor-pointer rounded-sm flex items-center gap-1.5 px-3 py-2 text-sm left-5 top-5 text-white bg-neutral-800 border border-neutral-600"
        >
            ...
            {messages.length === 0 ? (
              ...
              visibleMessages.map((message) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`${message.role === "user" ? "font-mono" : ""
      ...
      <div className="sticky bottom-0 mx-auto max-w-3xl w-full px-3">
        ...
        <div className="h-18 md:h-30 w-full pb-4">
